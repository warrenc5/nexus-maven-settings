...
*/
def options = [ n:'settings', f: './target/generated-resources/xml/xslt/settings.xml', u:'admin', p:'admin']
    //cli.parse(args)
...
try {
  scripts.read(name)
  newScript = false
  println "Existing Script named '$name' will be updated from '$file.path'"
}
catch (NotFoundException e) {
  println "Script named '$name' will be created from '$file.path'" 
}
